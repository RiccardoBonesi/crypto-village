...
async function BookRestaurant(transactionRequest) {
    ...
    // quando daily esiste già non aggiorna il registro di daily
    ...
    // await dailyReservationsRegistry.update(dailyReservations);
...
// TODO:
/*
 - se faccio bookrestaurant su un daily già esistente non viene aggiunto 
 - un customer non può prenotare più volte in un ristorante per la stessa data
 - delete restaurant reservation
 - gestire permessi (lottery, trip, umbrella, restaurant,...)
