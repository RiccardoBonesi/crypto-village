...
async function BookBeachUmbrella(transactionRequest) {
    ...
    // controlla che non sia già prenotato
    // se già prenotato ritorna errore come date non valide
    // se no aggiungi prenotazione all'array
    ...
    //let beachUmbrella = await getAssetRegistry('org.digitalpayment.BeachUmbrella');
    ...
    // testare if(prova){x=0} per vedere cosa succede se fallisce qui
